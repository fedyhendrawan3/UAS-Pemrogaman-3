        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="tampil_kategori.php">Master Kategori</a></li>
          ...
          <form  method="POST">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nama" placeholder="Isi Nama Kategori" name="nama" required>
                    </div>
                </div>
                <!-- /.card-body -->
